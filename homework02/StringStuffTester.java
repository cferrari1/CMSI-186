 ...
 *  @version 2.0.1  2018-02-01  Christopher Ferrari  Fixed errors in some tests and comments
...
public class StringStuffTester {
   ...
   */
   public static void main ( String [] args ) {
      System.out.println( "\nA TOTAL OF SIXTY-FOUR TESTS TO CHECK OPERATION OF THE STRINGSTUFF CLASS METHODS");
   ...
   */
   public static void test_oddsOnly() {
      ...
      try { System.out.println( (0 == StringStuff.oddsOnly( "xy$%lo23ph((on97es" ).compareTo( "yooes" )) ? "got it" : "don't got it" ); }
      catch( Exception e ) { System.out.println ( false ); }
   ...
   */
   public static void test_oddsOnlyNoDupes() {
      ...
      System.out.print( "   Testing 'shshshshshshshsh' should return s: " );
      try { System.out.println( (0 == StringStuff.oddsOnlyNoDupes( "shshshshshshshsh" ).compareTo("s")) ? "got it" : "don't got it" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'AAbbAAbbCCddCCdd' should return AC: " );
